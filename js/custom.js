...
//    console.log(color.toRGBA().toString());
    ...
    pickrr.on('change', (color, instance) => {
        var colorCode = color.toHEXA().toString();
        
        document.documentElement.style.setProperty("--btnColor", colorCode)
    console.log(color.toHEXA().toString());
//    console.log(color.toRGBA().toString());
})
    ...
    // Simple example, see optional options for more configuration.
    const pickrrr = Pickr.create({
        el: '.color_picker_overlay',
        theme: 'classic', // or 'monolith', or 'nano'
    ...
    pickrrr.on('change', (color, instance) => {
        var colorCode = color.toHEXA().toString();
        
        document.documentElement.style.setProperty("--overlayColor", colorCode)
    console.log(color.toHEXA().toString());
//    console.log(color.toRGBA().toString());
})
